  ...
  return (
    <section className="flex min-h-dvh flex-col bg-brown pb-40">
      ...
      <div className="mx-auto w-full max-w-216.25 px-6 pt-7.5">
        <h1 className="text-center text-5xl font-semibold uppercase leading-none tracking-[-0.02em] text-peach xs:text-[5.75rem]">
          {title}
        </h1>
      </div>

      <div className="mx-auto mt-24 grid w-full max-w-260 gap-10 px-6 xs:mt-28 xs:grid-cols-2 xs:gap-8">
        {blocks.map((block) => (
